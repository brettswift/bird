...
describe Bird::Vm do
  ...
  vm_sample_full={
    ...
    :vm_name => "Bretts API Test Server",
  ...
  it "should create a vm given array from vapp summary" do
    ...
    vm = Bird::Vm.new(nil, vm_sample_from_vapp)
  ...
  it "should create a vm given full response from API" do
    ...
    vm = Bird::Vm.new(vm_sample_full, nil)
    
    vm.friendlyName.must_equal "Bretts API Test Server"
